...
const hardware: HardwareItem[] = [
  ...
  { icon: "GPU", label: "Grafikkarte", name: "MSI GeForce RTX 4070 Ti SUPER Ventus 2X OC", detail: "16 GB · GeForce RTX 40 SUPER", href: "https://geizhals.de/?fs=MSI+GeForce+RTX+4070+Ti+SUPER+Ventus+2X+OC", featured: true },
...
export function SetupGrid() {
  return (
    <>
      ...
      <p className={styles.note}>Produktlinks führen zu Geizhals Deutschland. Bei RAM und Grafikkarte führt der Link zur passenden Geizhals-Suche, da die exakte Artikelvariante aus der bisherigen Setup-Angabe nicht eindeutig hervorgeht.</p>
    </>
  );
}