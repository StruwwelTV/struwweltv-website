...
export function AdminControlCenter() {
  ...
  return <main className={styles.shell}><div className={styles.wrap}>
    ...
    <section className={styles.hero}><span className={styles.eyebrow}>STRUWWELTV // CONTROL CENTER</span><h1>Dein Chaos.<br/>Deine Regeln.</h1><p>Streamplan, Website-Texte, Setup, Community-Links und Rechtliches direkt verwalten – ohne GitHub und ohne neuen Deploy.</p></section>
