    ...
    <main>
      <header className="nav-shell">
        ...
        <nav className="desktop-nav" aria-label="Hauptnavigation">
          <Link href="#live">Live</Link><Link href="#clips">Clips</Link><Link href="#about">Über mich</Link><Link href="#setup">Setup</Link><Link href="#schedule">Streamplan</Link><Link href="#community">Community</Link>
        </nav>
      ...
      <section className="hero" id="top">
        ...
        <div className="hero-copy">
          <LiveBadge /><p className="kicker">WARZONE · ENTERTAINMENT · COMMUNITY</p>
          <h1>CHAOS.<br /><span>KUGELN.</span><br />COMMUNITY.</h1>
          <p className="hero-text">Fragwürdige Entscheidungen, überraschend gute Runden und eine Community, die Treffer genauso feiert wie komplette Totalausfälle.</p>
