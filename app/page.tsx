...
export default function Home() {
  return (
    <main>
      ...
      <section className="section" id="setup"><div className="section-head setup-head"><div><p className="kicker">UNTER DER HAUBE</p><h2>Mein Setup.</h2></div><p>Genug Leistung für gute Plays, schlechte Entscheidungen und alles dazwischen. Das steckt im Rechner hinter StruwwelTV.</p></div><SetupGrid /><div className="setup-strip card"><span>THE BUILD</span><strong>7800X3D</strong><i>×</i><strong>RTX 4070 Ti SUPER</strong><i>×</i><strong>32 GB DDR5</strong></div></section>
